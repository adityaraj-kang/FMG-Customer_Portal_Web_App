...
function Frame1() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white content-stretch flex flex-col gap-[10px] items-center justify-center left-[calc(50%+93.5px)] p-[10px] top-[calc(50%+260px)] w-[128px]">
      <div aria-hidden="true" className="absolute border border-black border-solid inset-0 pointer-events-none" />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[18px] text-black">Cheapest</p>
      <div className="bg-[#d9d9d9] shrink-0 size-[64px]" />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[18px] text-black">Price</p>
    </div>
  );
...
export default function Options() {
  return (
    <div className="bg-white relative size-full" data-name="Options">
